...
namespace Defra.UI.Tests.Feature.Regression.Exporter.Deeplink
{
    ...
    [NUnit.Framework.DescriptionAttribute("Deeplinks")]
    [NUnit.Framework.CategoryAttribute("Exporter")]
    public partial class DeeplinksFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Feature/Regression/Exporter/Deeplink", "Deeplinks", "As a Defra customer, I am able to Deeplink to application and add new Commodity ", ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Deeplink Tests for adding new Commodity")]
        [NUnit.Framework.TestCaseAttribute("exporter", "8361", "030231", "1", null)]
        public void DeeplinkTestsForAddingNewCommodity(string logininfo, string certificate, string commodityNumber, string noofidentification, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Deeplink Tests for adding new Commodity", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
