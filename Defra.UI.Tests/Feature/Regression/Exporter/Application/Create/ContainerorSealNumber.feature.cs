...
namespace Defra.UI.Tests.Feature.Regression.Exporter.Application.Create
{
    ...
    [NUnit.Framework.DescriptionAttribute("Container or Seal Number")]
    [NUnit.Framework.CategoryAttribute("Exporter")]
    public partial class ContainerOrSealNumberFeature
    {
...
#line 1 "ContainerorSealNumber.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Feature/Regression/Exporter/Application/Create", "Container or Seal Number", "As a Defra customer, I am able to add Container and seal number section", ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Container or Seal Number")]
        [NUnit.Framework.TestCaseAttribute("exporter", "automationtest", "EHC8361", "030231", "1", "BICU1234567", "012345", null)]
        public void ContainerOrSealNumber(string logininfo, string reference, string certificate, string commodityNumber, string noofidentification, string containerno, string sealno, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("containerno", containerno);
            argumentsOfScenario.Add("sealno", sealno);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Container or Seal Number", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 6
...
#line hidden
#line 17
 testRunner.When("I navigate to container seal number page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 18
 testRunner.And(string.Format("complete \'{0}\' and \'{1}\' and continue", containerno, sealno), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 19
 testRunner.Then("verify container and seal number has been added successfully", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
