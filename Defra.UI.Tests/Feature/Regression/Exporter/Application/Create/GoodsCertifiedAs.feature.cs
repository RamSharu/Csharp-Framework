...
namespace Defra.UI.Tests.Feature.Regression.Exporter.Application.Create
{
    ...
    [NUnit.Framework.DescriptionAttribute("Goods Certified AS")]
    [NUnit.Framework.CategoryAttribute("Exporter")]
    public partial class GoodsCertifiedASFeature
    {
...
#line 1 "GoodsCertifiedAs.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Feature/Regression/Exporter/Application/Create", "Goods Certified AS", "As a Defra customer, I am able to add Good Certified as section", ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Select goods certified as")]
        [NUnit.Framework.TestCaseAttribute("exporter", "automationtest", "EHC8361", "030231", "1", "Human consumption", null)]
        public void SelectGoodsCertifiedAs(string logininfo, string reference, string certificate, string commodityNumber, string noofidentification, string goodscertifiedas, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Select goods certified as", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 5
...
#line hidden
#line 16
 testRunner.When(string.Format("select goods certified as \'{0}\' and continue", goodscertifiedas), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 17
 testRunner.Then("verify goods certified has been added successfully", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
