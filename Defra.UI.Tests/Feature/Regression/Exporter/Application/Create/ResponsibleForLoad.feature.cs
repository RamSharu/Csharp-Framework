...
namespace Defra.UI.Tests.Feature.Regression.Exporter.Application.Create
{
    ...
    [NUnit.Framework.DescriptionAttribute("Responsible For Load")]
    [NUnit.Framework.CategoryAttribute("Exporter")]
    public partial class ResponsibleForLoadFeature
    {
...
#line 1 "ResponsibleForLoad.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Feature/Regression/Exporter/Application/Create", "Responsible For Load", "As a Defra customer, I am able to complete responsible for load section", ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Responsible For Load")]
        [NUnit.Framework.TestCaseAttribute("exporter", "automationtest", "EHC8361", "030231", "1", "XI", "defra", null)]
        public void ResponsibleForLoad(string logininfo, string reference, string certificate, string commodityNumber, string noofidentification, string responsibleforloadcountry, string responsibleforloadoperator, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("responsibleforloadcountry", responsibleforloadcountry);
            argumentsOfScenario.Add("responsibleforloadoperator", responsibleforloadoperator);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Responsible For Load", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 5
...
#line hidden
#line 16
 testRunner.When("I navigate to responsible for load page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 17
 testRunner.And(string.Format("complete responsible for load \'{0}\' and \'{1}\' and continue", responsibleforloadcountry, responsibleforloadoperator), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 18
 testRunner.Then("verify responsible for load has been added successfully", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
