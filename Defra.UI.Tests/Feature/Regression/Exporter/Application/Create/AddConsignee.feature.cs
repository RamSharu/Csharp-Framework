...
namespace Defra.UI.Tests.Feature.Regression.Exporter.Application.Create
{
    ...
    [NUnit.Framework.DescriptionAttribute("AddConsignee")]
    [NUnit.Framework.CategoryAttribute("Exporter")]
    public partial class AddConsigneeFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Feature/Regression/Exporter/Application/Create", "AddConsignee", "As a Defra customer, I am able to add Consignee in new application", ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Add consignee to new application")]
        [NUnit.Framework.TestCaseAttribute("exporter", "automationtest", "EHC8361", "030231", "1", "Defra eTrade", "XI", null)]
        public void AddConsigneeToNewApplication(string logininfo, string reference, string certificate, string commodityNumber, string noofidentification, string consigneeName, string consigneeCountry, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("consigneeName", consigneeName);
            argumentsOfScenario.Add("consigneeCountry", consigneeCountry);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Add consignee to new application", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 5
...
#line hidden
#line 16
 testRunner.And(string.Format("add consignee \'{0}\' for \'{1}\' and continue", consigneeName, consigneeCountry), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 17
 testRunner.And("verify consignee has been added successfully", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            }
