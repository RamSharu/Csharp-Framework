...
namespace Defra.UI.Tests.Feature.Regression.Exporter.Application.Create
{
    ...
    [NUnit.Framework.DescriptionAttribute("Region Of Certification")]
    [NUnit.Framework.CategoryAttribute("Exporter")]
    public partial class RegionOfCertificationFeature
    {
...
#line 1 "RegionOfCertification.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Feature/Regression/Exporter/Application/Create", "Region Of Certification", "As a Defra customer, I am able to select Region of Certification", ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Select Region of Certification")]
        [NUnit.Framework.TestCaseAttribute("exporter", "automationtest", "EHC8361", "030231", "1", "England", null)]
        public void SelectRegionOfCertification(string logininfo, string reference, string certificate, string commodityNumber, string noofidentification, string region, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Select Region of Certification", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
...
#line hidden
#line 15
 testRunner.And("navigate to region of certification page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 16
 testRunner.And(string.Format("select the region of certification \'{0}\' and continue", region), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 17
 testRunner.And("verify region of certification has been completed successfully", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            }
