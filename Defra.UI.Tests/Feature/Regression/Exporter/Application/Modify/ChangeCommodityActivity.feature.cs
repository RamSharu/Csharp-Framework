...
namespace Defra.UI.Tests.Feature.Regression.Exporter.Application.Modify
{
    ...
    [NUnit.Framework.DescriptionAttribute("ChangeCommodityActivity")]
    [NUnit.Framework.CategoryAttribute("Exporter")]
    public partial class ChangeCommodityActivityFeature
    {
...
#line 1 "ChangeCommodityActivity.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Feature/Regression/Exporter/Application/Modify", "ChangeCommodityActivity", "As a Defra customer, I am able to change Commodity activity", ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.TestCaseAttribute("exporter", "automationtest", "EHC8361", "030231", "1", "Minced meat plant", null)]
        public void ChangeCommodityRecord(string logininfo, string reference, string certificate, string commodityNumber, string noofidentification, string activityName, string[] exampleTags)
        {
...
#line hidden
#line 15
 testRunner.And(string.Format("change commodity activity to \'{0}\'", activityName), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 16
 testRunner.And(string.Format("verify commodity activity \'{0}\' has been changed successfully", activityName), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            }
