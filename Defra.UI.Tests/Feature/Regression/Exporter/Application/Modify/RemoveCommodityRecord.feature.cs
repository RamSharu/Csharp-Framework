...
namespace Defra.UI.Tests.Feature.Regression.Exporter.Application.Modify
{
    ...
    [NUnit.Framework.DescriptionAttribute("RemoveCommodityRecord")]
    [NUnit.Framework.CategoryAttribute("Exporter")]
    public partial class RemoveCommodityRecordFeature
    {
...
#line 1 "RemoveCommodityRecord.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Feature/Regression/Exporter/Application/Modify", "RemoveCommodityRecord", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("EHC New Application - Remove commodity records")]
        [NUnit.Framework.TestCaseAttribute("exporter", "automationtest", "EHC8361", "030231", "1", null)]
        public void EHCNewApplication_RemoveCommodityRecords(string logininfo, string reference, string certificate, string commodityNumber, string noofidentification, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("EHC New Application - Remove commodity records", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
...
#line hidden
#line 15
 testRunner.When("I click on remove commodity link", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 16
 testRunner.Then("I can verify that the commodity has been removed successfully", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
