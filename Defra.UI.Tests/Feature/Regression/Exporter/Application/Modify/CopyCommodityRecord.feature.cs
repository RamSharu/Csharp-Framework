...
namespace Defra.UI.Tests.Feature.Regression.Exporter.Application.Modify
{
    ...
    [NUnit.Framework.DescriptionAttribute("CopyCommodityRecord")]
    [NUnit.Framework.CategoryAttribute("Exporter")]
    public partial class CopyCommodityRecordFeature
    {
...
#line 1 "CopyCommodityRecord.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Feature/Regression/Exporter/Application/Modify", "CopyCommodityRecord", "As a Defra customer, I am able to copy commodities in a new application", ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("EHC New Application - Copy commodity records")]
        [NUnit.Framework.TestCaseAttribute("exporter", "automationtest", "EHC8361", "030231", "1", null)]
        public void EHCNewApplication_CopyCommodityRecords(string logininfo, string reference, string certificate, string commodityNumber, string noofidentification, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("EHC New Application - Copy commodity records", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 5
...
#line hidden
#line 16
 testRunner.When("I click on copy commodity link", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 17
 testRunner.Then("I can verify that the commodity has been copied successfully", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
