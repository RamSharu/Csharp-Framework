...
namespace Defra.UI.Tests.Feature.Regression.Exporter.E2E
{
    ...
    [NUnit.Framework.DescriptionAttribute("EHCE2E_EHC8324")]
    [NUnit.Framework.CategoryAttribute("Exporter")]
    [NUnit.Framework.CategoryAttribute("Pre")]
    public partial class EHCE2E_EHC8324Feature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Feature/Regression/Exporter/E2E", "EHCE2E_EHC8324", "As a Defra customer, I am able to create and submit a new application", ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Create and submit a new EHC application EHC8324")]
        [NUnit.Framework.TestCaseAttribute("exporter", "automationE2E8324", "EHC8324", "230910", new string[] {
                "Regression",
                "Pre"}, Category="Regression,Pre")]
        public void CreateAndSubmitANewEHCApplicationEHC8324(string logininfo, string reference, string eHCNumber, string commodityNumber, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Create and submit a new EHC application EHC8324", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 6
