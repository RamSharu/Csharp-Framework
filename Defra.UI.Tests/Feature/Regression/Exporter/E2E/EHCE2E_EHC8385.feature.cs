...
namespace Defra.UI.Tests.Feature.Regression.Exporter.E2E
{
    ...
    [NUnit.Framework.DescriptionAttribute("EHCE2E_EHC8385")]
    public partial class EHCE2E_EHC8385Feature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Feature/Regression/Exporter/E2E", "EHCE2E_EHC8385", "As a Defra customer, I am able to create and submit a new application", ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Create and submit a new EHC application EHC8385")]
        [NUnit.Framework.TestCaseAttribute("exporter", "automationE2E8385", "EHC8385", "160232", new string[] {
                "Exporter",
                "Pre"}, Category="Exporter,Pre")]
        public void CreateAndSubmitANewEHCApplicationEHC8385(string logininfo, string reference, string eHCNumber, string commodityNumber, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Create and submit a new EHC application EHC8385", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 5
