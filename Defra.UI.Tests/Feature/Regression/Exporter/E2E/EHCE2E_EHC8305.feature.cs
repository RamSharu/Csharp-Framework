...
namespace Defra.UI.Tests.Feature.Regression.Exporter.E2E
{
    ...
    [NUnit.Framework.DescriptionAttribute("EHCE2E_EHC8305")]
    [NUnit.Framework.CategoryAttribute("Exporter")]
    [NUnit.Framework.CategoryAttribute("Pre")]
    public partial class EHCE2E_EHC8305Feature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Feature/Regression/Exporter/E2E", "EHCE2E_EHC8305", "As a Defra customer, I am able to create and submit a new application", ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Create and submit a new EHC application EHC8305")]
        [NUnit.Framework.TestCaseAttribute("exporter", "automationE2E8305", "EHC8305", "230910", new string[] {
                "Regression",
                "Pre"}, Category="Regression,Pre")]
        public void CreateAndSubmitANewEHCApplicationEHC8305(string logininfo, string reference, string eHCNumber, string commodityNumber, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Create and submit a new EHC application EHC8305", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 6
