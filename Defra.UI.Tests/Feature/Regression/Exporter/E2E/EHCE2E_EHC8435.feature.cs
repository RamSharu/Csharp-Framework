...
namespace Defra.UI.Tests.Feature.Regression.Exporter.E2E
{
    ...
    [NUnit.Framework.DescriptionAttribute("EHCE2E_EHC8435")]
    public partial class EHCE2E_EHC8435Feature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Feature/Regression/Exporter/E2E", "EHCE2E_EHC8435", "As a Defra customer, I am able to create and submit a new application", ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("Create and submit a new EHC application EHC8435")]
        [NUnit.Framework.TestCaseAttribute("exporter", "automationE2E8435", "EHC8435", "0105120", new string[] {
                "Exporter",
                "Pre"}, Category="Exporter,Pre")]
        public void CreateAndSubmitANewEHCApplicationEHC8435(string logininfo, string reference, string eHCNumber, string commodityNumber, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Create and submit a new EHC application EHC8435", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 5
